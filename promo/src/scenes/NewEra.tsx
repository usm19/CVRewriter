  ...
  return (
    <Stage>
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", gap: 54 }}>
        <Interactive.Div name="Headline" style={{ fontSize: portrait ? 100 : 148, fontWeight: 750, letterSpacing: "-0.035em", ...fadeUp(frame, 8, 26) }}>
          A new era of applying.
        </Interactive.Div>
        <Interactive.Div
          name="UrlPill"
          style={{
            fontSize: portrait ? 46 : 54, fontWeight: 650, color: C.text, background: C.surface, borderRadius: 999, padding: "30px 58px",
        ...
        <Interactive.Div name="Sub" style={{ fontSize: portrait ? 42 : 48, color: C.text2, ...fadeUp(frame, 78) }}>
